...
import {addTodolistAC, changeTodolistTitleAC, removeTodolistAC, todolistsReducer} from "./state/todolists-reducer";
...
function AppWithReducers() {
    //хук useReducer работает только с одним редьюсером
